...
public class IASKPSPublicSoap
{
    ...
    public IASKPSPublicSoap(){}

    public IASKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IASKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IASExtendedSoapSerializationEnvelope envelope= new IASExtendedSoapSerializationEnvelope(IASExtendedSoapSerializationEnvelope.VER11);
