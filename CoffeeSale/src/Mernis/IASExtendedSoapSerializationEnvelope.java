...
public class IASExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IASDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IASStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IASDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IASDateTimeConverter dateTimeConverter = new IASStandardDateTimeConverter();

    public IASExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IASExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IASMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IASHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IASExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IASHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
